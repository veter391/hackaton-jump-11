...
const Card1 = memo(
  (props) => {
    ...
    ><Theme name={tint}><YStack
      ...
      {...cardProps}
    >
      <XStack ai="center" p="$4" space="$5"><YStack als="center" y={-3} miw={165} jc="center">
        <Paragraph fontWeight="700">Billie Jean</Paragraph>
        <Paragraph color="$color11" size="$3">Michael Jackson</Paragraph>
        <Paragraph color="$color11" o={0.65} size="$3">Thriller</Paragraph>
      </YStack></XStack>
      <Separator mb={-1} />
      <XStack
        zi={1e3}
